...
<body style="background-color: rgb(242, 146, 145);">
	...
	<div class="container" align="center">                                         
		<input type="button" onclick="window.location='http://localhost/cert_gen/Template1.php'" class="Redirect" value="Choose this template"/>
		<img src="temp.png" style="width:25%;">
	</div>
	<br>
	<div class="container" align="center">
		<input type="button" onclick="window.location='http://localhost/cert_gen/Template2.php'" class="Redirect" value="Choose this template"/>
		<img src="temp2.png" style="width:25%;">
	</div>
	<br>
	<div class="container" align="center">
		<input type="button" onclick="window.location='http://localhost/cert_gen/Template3.php'" class="Redirect" value="Choose this template"/>
